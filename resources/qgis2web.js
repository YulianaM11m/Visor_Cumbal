...
map.getView().fit([-8721157.249052, 77338.234663, -8635398.201830, 125938.782080], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Geovisor Cumbal</h2>';
        return titleElement;
    })(),
